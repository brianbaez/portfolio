        ...
        <div className="contact__inner-container">
          ...
          <div class="contact__form">
            <form action="https://formspree.io/f/xoqregpk" method="POST" id="my-form" onSubmit={(e) => handleSubmit(e)}>
              <input type="text" name="name" class="name" placeholder="Name" required></input>
              <input type="email" name="email" class="email" placeholder="Email" required></input>
              <textarea name="message" class="message" rows="10" placeholder="Message" required></textarea>
              <button class="submit button" type="submit" name="button">Send</button>
              <p class="status" id="my-form-status"></p>
            </form>
          </div>
        </div>
      </div>
